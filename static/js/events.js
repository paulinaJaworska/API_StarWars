...
import {showResidentsModal, showPlanetsTable, showResidentsTable, clearElementContent,
    showVotingTable, showStatsModal,
    //handleNavigationBar
    }
    from "./view.js";
...
requestPlanetsData(showPlanetsTable, pagination.buttonStatusCheck); // mogą się zmienić w trakcie, odświeżanie

// event bubbling //gorsza czytelność kodu,
